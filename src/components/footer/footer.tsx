...
export default function Footer () {
    ...
    return ( 
        <footer className="container min-w-full bg-black   ">
            <div className="flex items-center justify-center h-auto container mx-auto bg-black">
                        <div className="w-1/4  m-4  pl-4 pr-4">
                ...
                <p className="text-center justify-center text-xl text-white h-20">Derecho reservado a NYX TEchnologies SA.</p>
            </footer>
    )
}